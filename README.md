# template-kitchen-fitter

A standalone SEOJack website template. Lean Next.js 16 app (App Router, React 19,
scoped CSS — no Tailwind/Convex/Clerk).

- **Live:** https://kitchen-fitter.templates.seojack.website
- **Registry id:** `tpl_kitchen_fitter`
- **Showcased on:** https://seojack.net/templates/tpl_kitchen_fitter
...
| `app/styles.ts` | one scoped CSS literal (every selector prefixed `.kitchen-fitter-demo`) |
...
Own GitHub repo (`seojack-templates/template-kitchen-fitter`) + own Vercel project,
production domain `https://kitchen-fitter.templates.seojack.website`. See `docs/templates-github-org.md`.